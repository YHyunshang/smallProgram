...
const productPlaceholderImg =
  Platform.OS === 'ios'
    ? require('@img/placeholder-product.png')
    : { uri: 'asset:/src_assets_imgs_placeholderproduct.png' }
...
function ProductItem({
  data: { imgUrl, label, name, price, productDesc, promotionPrice, code },
}: Props) {
    ...
    <View style={styles.container}>
      ...
      <View style={styles.productDetailBox}>
        ...
        <View style={styles.btmBox}>
          ...
          <TouchableOpacity
            activeOpacity={0.8}
            onPress={() => CMSServices.addToCart(code, 1, price)}
          >
