 ...
 * @LastEditTime: 2019-08-28 16:18:44
 */
...
export const helpFeedBackAnswer = {
  goodsQuestion: [
    {
      ...
      questionContent: '1、签收时请您仔细核对商品，如有质量问题或少/漏/破损等，可向配送员提出拒收或者提出补发/更换商品需求，由骑手反馈门店处理；2、签收后，如有质量问题或少/漏/破损等，请在24小时内拍照留证，保存问题商品并进入APP/小程序【会员中心】-【全部订单】-【订单详情】-【申请退货】申请售后或联系客服处理。'
    },
    {
  ...
  refundQuestion: [
    ...
    },
    {
      ...
      questionContent: '支持7天无理由退货的商品，客户可以在收到商品七日内申请退货，且无需说明理由，但下列商品除外：1、定制类商品：如个性定制、设计服务；2、鲜活易腐类商品:如鲜花绿植、新鲜蔬果、烘焙熟食、鲜奶、禽肉禽蛋、海鲜水产、冷藏食品、冷冻食品、水产肉类加工品、宠物等；3、在线下载或者激活的数字化商品:如电子券包4、一经激活或者试用后价值贬损较大的商品，或非生活消费所需的商品：如智能设备、商用厨具、内裤、短袜/打底袜/丝袜/美腿袜、塑身裤、塑身连体衣、乳贴、插片/胸垫等5、拆封后影响人身安全或者生命健康的商品，或者拆封后易导致商品品质发生改变的商品：如食品、保健品、贴身用品等；客户7天无理由退货的商品应当包装完好、配件齐全，塑封商品未拆封，和客户另有约定的，按照约定执行。'
    },
    {
      questionTitle: '商品不想要了，怎么退款退货',
      questionContent: '生鲜商品具有新鲜度、易腐性等特征，目前不支持无理由退换货；1、若订单状态是“备货中”，可在订单详情选择“退款”，已支付的款项和优惠券将在1-3个工作日内原路返回到原支付账户中2、如果订单状态是“已配送”，可联系配送员提出拒收，门店会在收到您退回的商品后及时为您审批，通过后即可收到退款3、若您收到的商品有质量问题，请您在签收后24小时内拍照留证、保存商品并进入APP/小程序【会员中心】-【全部订单】-【订单详情】-【申请退货】申请售后，门店将在1个工作日内进行处理，审核通过后，款项将在1-3个工作日原路退回。'
    },
    {
