...
const ProductSection: React.FunctionComponent<ProductSectionProps> =
  ({ productData, initialData, onStatusChange }) => {
    ...
    const price = loading ? initialData.price : (detailData.promotionPrice || detailData.price)
        ...
        <View style={styles.section}>
          <Text style={styles.priceRow}>
            ...
            {(!!slashedPrice && slashedPrice > price) && (
              <Text style={styles.priceSlashedNormal}>¥{transPenny(slashedPrice)}</Text>
            )}
          </Text>
          ...
          <Text style={styles.nameRow}>{loading ? initialData.name : detailData.productName}</Text>
          {!!subTitle && (
            <Text style={styles.subTitleRow}>{subTitle}</Text>
          )}
