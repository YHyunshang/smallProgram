 ...
 * @LastEditTime: 2019-11-19 19:30:49
 */
...
export default class Activity extends React.Component<Props, State> {
 ...
 /**
    ...
    products.map((product, colIdx) => (
      <View
        style={[
          ...
          colIdx % this.state.columnNumber < this.state.columnNumber - 1 && this.state.themeStyles.columnNotLast,
        ]}
        key={product.code}
      >
  ...
  renderItemData = ({item, index}) => (
    ...
    :(
       <View style={this.state.themeStyles.container}>
           <View
              style={[this.state.themeStyles.row, index < this.state.gridTotal - 1 && this.state.themeStyles.rowNotLast]}
              key={index}
            >
  ...
  requestActivityData = async () => {
    ...
    let nextState = {
      currentTabKey: '',
      topTabList: result.map(ele => ({ key: ele.id, label: ele.showName })),
      tabContentMap: {},
    }
    if (result.length > 0) {
      const tab = result[0]
   ...
   */
  dataFormat = data => {
     data.sort((a, b) => a.pos - b.pos) // step 1: 排序
      .filter(
        // step 2: 过滤掉空数据
        ele =>
          ele.img ||
  ...
  componentDidMount() {
    ...
    let templateDetailVOList=[
      ...
      },
      {
        ...
        code: "317001",
        id: 243077,
        imgUrl: "http://hotfile.yonghui.cn/files/|cephdata|filecache|YHYS|YHYS|2019-08-27|7083850274447552512",
        inventoryLabel: null,
        label: "",
        labelList: ["5.9折"],
        link: null,
      ...
      },
      {
        ...
        code: "453376",
        id: 243081,
        imgUrl: "http://hotfile-cdn.yonghui.cn/files/|cephdata|filecache|YHYS|YHYS|2019-06-28|1953323563805052928",
        inventoryLabel: null,
        label: "",
        labelList: ["6.3折"],
        link: null,
      ...
      },
      {
        ...
        code: "1042792",
        id: 243083,
        imgUrl: "http://hotfile.yonghui.cn/files/|cephdata|filecache|YHYS|YHYS|2019-09-20|7917069566465806336",
        inventoryLabel: null,
        label: "",
        labelList: ["5.0折"],
        link: null,
    ...
    this.setState({products,total,gridProducts,gridTotal,columnNumber,theme,themeStyles})
  ...
  render() {
    const{currentTabKey,loading,products,topTabList,leftTabList,showBar, cart: { amount, count }}=this.state
      ...
      <View style={styles.container}>
        ...
        <View style={styles.centerWrapper}>
            ...
            <FlatList
              ...
              data={ this.state.columnNumber === 1 ? products : this.state.gridProducts}
